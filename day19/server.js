...
const authMiddleware = async(req, res, next) => {
    ...
    //check if email is equal to the decoded token, if it is not, 
...
//get user route
app.post('/getuser', authMiddleware,  getUser);

//get all users route
app.get('/getAllUsers', getAllUsers);

//updateUser route
app.put('/updateUser', authMiddleware, updateUser);

//delete user route
app.delete('/deleteUser', authMiddleware, deleteUser);
